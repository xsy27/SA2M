...
class FeatureExtractor:
    ...
    def get_harmonic_melspe_db(audio_harmonic, sr):
        harmonic_melspe = librosa.feature.melspectrogram(y=audio_harmonic, sr=sr)
    ...
    def get_onset_strength(audio_percussive, sr):
        onset_env = librosa.onset.onset_strength(y=audio_percussive, sr=sr, aggregate=np.median)
